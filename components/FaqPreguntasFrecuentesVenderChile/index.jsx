    ...
    <Accordion allowZeroExpanded className={styles.accordion}>
      ...
      <AccordionItem className={styles.accordion__item}>
        ...
        <AccordionItemPanel className={styles.accordion__panel}>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>1.Publicamos tu auto en los portales más importantes de Chile (Yapo, Chileautos, Mercado Libre y nuestro catálogo).</ol></ul>
            </div>
          </div>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
          ...
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>8.Ofrecemos variedad de métodos de pago (vale vista, transferencia bancaria, depósitos y tarjetas de crédito) para mayor comodidad del comprador.</ol></ul>
            </div>
          </div>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>9.Ofrecemos financiamiento a través de las instituciones más importantes de Chile y aceptamos retomas mediante automotoras para atraer a un mayor caudal de interesados.</ol></ul>
            </div>
          </div>
        </AccordionItemPanel>
      </AccordionItem>
      ...
      <AccordionItem className={styles.accordion__item}>
        ...
        <AccordionItemPanel className={styles.accordion__panel}>
          <p>Aceptamos todas las marcas y modelos de auto que se encuentren en la Región Metropolitana de Santiago de Chile siempre y cuando cumplan con las siguientes características: </p>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
      ...
      <AccordionItem className={styles.accordion__item}>
        ...
        <AccordionItemPanel className={styles.accordion__panel}>
          ...
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
              <ul><ol>Nuestro comienzo en Chile data de octubre del 2019 por dos emprendedores argentinos, Martín Salassa y Nicolás Ochoa, y actualmente somos una de las plataformas mejor valoradas del país con más de 260 reseñas positivas.</ol></ul>
            </div>
          </div>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">
