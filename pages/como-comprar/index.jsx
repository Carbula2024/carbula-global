...
const ComoComprar = () => {
      ...
      <div>
        ...
        <div className={styles.comprar}>
          <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            <h4 itemprop="name">1. ¿Qué tipo de autos tienen?</h4>
            ...
            <h4 itemprop="name">2. Me interesa un vehículo en particular, ¿qué hago?</h4>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <div itemprop="text">
            ...
            <h4 itemprop="name">3. ¿En qué consiste la visita vehicular?</h4>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <div itemprop="text">
            ...
            <h4 itemprop="name">4. Todavía no sé qué auto quiero</h4>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <div itemprop="text">
            ...
            <h4 itemprop="name">5. ¿Qué métodos de pago aceptan?</h4>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <div itemprop="text">
            ...
            <h4 itemprop="name">7. ¿Aceptan mi auto cómo método de pago?</h4>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <div itemprop="text">
            ...
            <h4 itemprop="name">8. ¿Cómo es el proceso de compra?</h4>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <div itemprop="text">
            ...
            <h4 itemprop="name">9. Listo, quiero comprar con ustedes.</h4>
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <div itemprop="text">
  ...
  if (router.locale === 'es-PE') {
    return (
      <div>
        <Head title="Compra un auto de forma segura | Carbula Autos Perú" />
        <Nav />
        <div className={styles.header}>
        <a href="https://catalogo.carbula.pe/"><h1>Compra un auto de forma segura</h1></a>
        </div>
        <div className={styles.comprar}>
          <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            <h4 itemprop="name">1. ¿Qué tipo de autos tienen?</h4>
